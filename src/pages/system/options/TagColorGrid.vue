  ...
  <div class="column q-gutter-sm">
    ...
    >
      <q-input
        ...
        class="col"
        :label="gettext('Tag')"
        :rules="[(value) => /^[a-z0-9+_.-]+$/i.test(value) || gettext('Invalid tag')]"
      />
      <q-input
        v-model="entry.background"
        dense
        class="col"
        :label="gettext('Background Color')"
        :rules="[
          (value) => /^[0-9a-f]{6}$/i.test(value) || gettext('Use a 6-digit hexadecimal color'),
        ]"
      />
      <q-input
        v-model="entry.foreground"
        dense
        class="col"
