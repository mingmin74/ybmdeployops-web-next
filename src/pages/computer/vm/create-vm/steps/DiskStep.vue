...
const { diskBusOptions, diskBusSlotLimits, cacheOptions, aioOptions, isoStorageColumns, importImageColumns } = options;
const { extraDisks, primaryDiskKey, diskCount, diskAddDisabled, diskValidation, addExtraDisk, addImportDisk, removeExtraDisk, removePrimaryDisk, loadImportImages, diskFormatOptions, diskFormatDisabled } = disks;
                          ...
                          <template v-if="disk.isImport">
                            <div class="col-12 col-sm-6">
                              <SelectTable
                                ...
                                :error-message="
                                  validationErrors[`disk-${disk.id}-import-storage`] || ''
                                "
                            ...
                            <div class="col-12 col-sm-6">
                              <SelectTable
                                ...
                                :error-message="
                                  validationErrors[`disk-${disk.id}-import-from`] || ''
                                "
